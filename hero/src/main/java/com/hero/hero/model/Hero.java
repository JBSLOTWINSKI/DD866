...
public class Hero {
    ...
    @Max(value = 10, message = "Les points de vies ne peuvent pas être au-dessus de 10")
    @PositiveOrZero(message = "Attention action non autorisée")
    private int life;
    @Schema (name = "strength", example = "10")
    @Column (name = "strength", nullable = false)
    @NotNull
    @Min(value = 5, message = "Les points de force ne peuvent pas être en-dessous de 5")
    @Max(value = 10, message = "Les points de force ne peuvent pas être au-dessus de 10")
    @PositiveOrZero(message = "Attention action non autorisée")
    ...
    public Hero(int id, String name, String type, int life, int strength) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.life = life;

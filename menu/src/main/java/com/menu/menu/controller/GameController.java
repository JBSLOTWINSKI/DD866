...
//        FillHero fillHero = new FillHero();
...
//        List response = restTemplate.getForObject("http://172.22.114.79:8086/", List.class);
//
...
//
//    @PostMapping("/menu")
//    public String putInDatabase(Model model, @ModelAttribute("fillHero") FillHero fillHero) {
//        model.addAttribute("created-hero-title", "Votre personnage est créé");
//        model.addAttribute("fillHero", fillHero);
//
//        FillHero response = restTemplate.postForObject("http://172.22.114.79:8086/", fillHero, FillHero.class);
//
//        return "created-hero";
//    }
//

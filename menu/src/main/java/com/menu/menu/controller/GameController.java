...
public class GameController {
    ...
    String getHeroesList(Model model) {
        ...
        List response = restTemplate.getForObject("172.22.114.79:8081/", List.class);
    ...
    public String putInDatabase(Model model, @ModelAttribute("fillForm") FillHero fillHero) {
        model.addAttribute("created-hero-title", "Personnage créé");
        model.addAttribute("fillHero", fillHero);

        FillHero response = restTemplate.postForObject("172.22.114.79:8081/", fillHero, FillHero.class);
